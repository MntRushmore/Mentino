    ...
    <Layout title="About the Founder" user={user} currentPath="/founder">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-10 text-center text-white mb-10">
          ...
          <h1 className="text-3xl font-bold mb-2">Ethan Branzuela</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 mb-8">
          <div className="space-y-4 text-gray-600 leading-relaxed">
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">My Vision</h3>
            <p className="text-gray-600 leading-relaxed">
              My long-term vision for Mentino is simple but powerful:
            </p>
            <blockquote className="border-l-4 border-blue-500 pl-4 py-2 my-4 text-lg font-medium text-gray-800 italic">
