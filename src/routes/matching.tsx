          ...
          {results.length === 0 ? (
            ...
            <div className="space-y-5">
              {results.map((result, index) => {
                ...
                return (
                  <div key={result.mentorDbId} className={`bg-white rounded-2xl shadow-sm border overflow-hidden ${index === 0 ? "border-indigo-200 ring-1 ring-indigo-200" : "border-gray-100"}`}>
                    {index === 0 && (
